...
## Abrirá una página web, escoje un nombre único para el token, generarlo y copiarlo
# Pegarlo
gitcreds::gitcreds_set()
# Editar el archivo Renviron guardando el token como GITHUB_PAT=TU_CLAVE_DE_40_LETRAS
